              ...
              {drawername === "Amenities" ? (
                ...
                <div className={` h-auto`}>
                  <div className="flex w-full">
                    <button
                      className={`w-[50vw] h-[7vw] flex border-[0.15vw] rounded-l-[1vw] border-[#1F487C] px-[0.3vw] justify-center gap-[0.5vw] items-center ${
                        isToggleSwitch === "CDCP"
                          ? busType === "luxury"
                    ...
                    <button
                      className={`w-[50vw] h-[7vw] flex border-[0.15vw] border-[#1F487C] rounded-r-[1vw] px-[0.1vw] justify-center gap-[0.5vw] items-center ${
                        isToggleSwitch === "TRP"
                          ? busType === "luxury"
                            ? "bg-[#393939] border-[#393939]"
                            : busType === "regular"
                        ...
                        <div className="flex flex-col gap-[1vw]">
                          ...
                          {policies?.length > 0 &&
                            policies.map((item, index) => (
                              <p
                                className="text-[3.2vw] text-[#1F4B7F] py-[1vw]"
                                key={index}
                              >
                                <span
                                  className={`${
                          ...
                          <p
                            className={`${
                              busType === "luxury"
                                ? "text-[#393939]"
                                : "text-[#1F487C]"
                            } text-[3.2vw] font-semibold pl-[7vw]`}
                          >
                            Penalty(%)
                          </p>
                          {policies?.length > 0 &&
                              ...
                              <p
                                className={`${
                                  busType === "luxury"
                                    ? "text-[#393939]"
                                    : "text-[#1F487C]"
                                } text-[3.2vw] flex justify-center py-[1vw]`}
                              >
