...
export default function SelectedCardDesign({ item }) {
  ...
  return (
    <div className="">
      <div
        className={`h-[28vw]  mt-[7vw] relative ${
      ...
      >
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className=" absolute top-[-5vw] right-[22.2vw]"
        >
          <path
        ...
        <label
          className={` absolute left-[1.5vw] top-[-4.5vw] text-[2.5vw] ${
            item.bus_type_status === "luxury" ? "text-black" : "text-white"
        ...
        <div className="absolute top-[13vw] left-[20vw]">
          ...
          >
            <path
              ...
              fill={item.bus_type_status === "luxury" ? "#393939" : "#1F487C"}
            />
          </svg>
          <label
