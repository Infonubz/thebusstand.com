  ...
  return (
    <>
      ...
      <div className="md:hidden block fixed top-0">
        ...
        >
          <label className="text-white text-[8vw] font-bold absolute top-[13vw] left-[23vw] opacity-15">Privacy Policy</label>
          <label className="text-white text-[5vw] font-bold absolute top-[16vw] left-[32vw]">Privacy Policy</label>
        ...
        <div className="relative min-h-screen bg-[#E5FFF1] z-10">
          ...
          <div className="absolute top-[1vw] pr-[3vw]">
            <p className="text-[#1F487C] text-[5vw] font-bold px-[2vw]">Privacy Policy</p>
