...
import {
  SendBookingDetails, sendBookingPrice, TicketViewDetails,
  // GetBookingDetails,
                ...
                <div className="p-[2.5vw] md:p-[1.5vw] flex flex-col gap-y-[3vw] md:gap-y-[1.60vw]">
                  <div className="">
                    <Collapse
                      style={{
                        backgroundColor:
                          busdetails1.bus_type_status === "luxury" ? "#393939"
                            : colorcode.theme,
                      }}
                      ...
                      items={[
                        {
                          ...
                          children: (
                            ...
                            style={{
                              backgroundColor:
                              busdetails1.bus_type_status === "luxury"? "#FFEEC9"
                              : "white",
                            }}>
                                  ...
                                  <div className="flex flex-col h-[40%] items-center">
                                    <p
                                      className={`text-[1.1vw] font-bold ${
                                        busdetails1?.bus_type_status === "luxury"? "text-[#393939]"
                                          : "text-[#1F487C]"}`}>
                                      {busdetails1?.operator_name?.length > 23 ? (
                                        <Tooltip
                                          ...
                                          {`${busdetails1?.operator_name?.slice(0,22)}...`}
                                        </Tooltip>
                                      ) : (`${busdetails1?.operator_name?.slice(0,22)}`)}
                                    </p>
                                    <p
                                      className={`text-[1vw] ${ busdetails1.bus_type_status === "luxury"
                                          ? "text-[#393939]"
                                          : "text-[#1F487C]"
                                      }`}
                                    >
                                    ...
                                    <div className="grid md:grid-cols-4 grid-cols-7">
                                      <div className="md:col-span-1 col-span-2 ">
                                        <div className="flex flex-col pl-[1vw] text-left">
                                          <p className="md:text-[0.8vw] text-[3.5vw]  pt-[0.5vw]">
                                            {dayjs(busdetails1?.departure_date_time).format("DD MMM")}
                                          </p>
                                          <p
                                          ...
                                          >
                                            {dayjs( busdetails1?.departure_date_time ).format("hh:mm A")}
                                          </p>
                                          <p
                                            className={`md:text-[0.9vw] text-[3vw] ${
                                              busdetails1.bus_type_status ==="luxury" ? "text-[#393939]" : "text-[#1F487C]"
                                            }`}
                                          >
                                          ...
                                          <div className="absolute md:left-0 left-[-1.2vw] md:top-[1.2vw] w-[33vw] md:w-[18.5vw]">
                                            ...
                                            >
                                              <line
                                                ...
                                                x2="279.058"
                                                y2="13.6426"
                                                stroke={busdetails1.bus_type_status === "luxury" ? "#393939" : "#1F4B7F"}
                                              ...
                                              <ellipse
                                                ...
                                                rx="5.82925"
                                                ry="5.42191"
                                                fill={busdetails1.bus_type_status === "luxury" ? "#393939" : "#1F4B7F"}
                                              />
                                              <path
                                                fill-rule="evenodd"
                                                clip-rule="evenodd"
                                      ...
                                      <div className="md:col-span-1 col-span-2 ">
                                        <div className="flex flex-col text-right pr-[1vw]">
                                          ...
                                          >
                                            {dayjs(busdetails1?.arrival_date_time).format("DD MMM")}
                                          </p>
                                          <p
                                          ...
                                          >
                                            {dayjs(busdetails1?.arrival_date_time).format("hh:mm A")}
                                          </p>
                                          <p
                                  ...
                                  <div className="row-span-2 flex justify-between px-[1vw] md:my-[0vw] my-[2vw] ">
                                      ...
                                      >
                                        {selectedRoutes1?.dep_route?.length > 25 ? (
                                          <Tooltip
                                            ...
                                            {`${selectedRoutes1?.dep_route?.slice(0,20)}... (${dayjs(selectedRoutes1?.dep_time).format("hh:mm A")})`}
                                          </Tooltip>
                                        ) : (
                                          `${selectedRoutes1?.dep_route?.slice(0,20)} (${dayjs(selectedRoutes1?.dep_time).format("hh:mm A")})`)}
                                      </p>
                                    ...
                                    <div className="flex flex-col items-center">
                                      ...
                                      <div className="text-[1.1vw] font-semibold">
                                        ...
                                        >
                                          {selectedSeats1?.length > 0 ? ( selectedSeats1.map((seat, index) => (
                                              <p
                                                key={index}
                                      ...
                                      >
                                        {selectedRoutes1?.arri_route?.length > 25 ? (
                                          <Tooltip
                                            ...
                                            {`${selectedRoutes1?.arri_route?.slice( 0,20)}... (${dayjs(selectedRoutes1?.arr_time).format("hh:mm A")})`}
                                          </Tooltip>
                                        ) : (
                                          `${selectedRoutes1?.arri_route?.slice( 0, 20)} (${dayjs(selectedRoutes1?.arr_time).format("hh:mm A")})`
                                        )}
                              ...
                              <span className="absolute md:block hidden left-[15.5vw]">
                                <div className="h-full py-[0.5vw]">
                                  <svg className=" md:h-[13.5vw] md:w-[3.3vw]"
                                    viewBox="0 0 58 233" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="24.7695" y="110.186" width="7.77032" height="7.77032" rx="3.88516"
                                      stroke={busdetails1.bus_type_status === "luxury" ? "#393939" : "#1F4B7F"} stroke-width="2.30622"/>
                                    <mask id="path-2-inside-1_6794_2554" fill="white"> <path d="M28.0771 117.016H29.2303V203.374H28.0771V117.016Z" /> </mask>
                                    <path
                                      ...
                                      fill={busdetails1.bus_type_status === "luxury" ? "#393939" : "#1F4B7F"} mask="url(#path-2-inside-1_6794_2554)"/>
                                    <line x1="11.3012" y1="232.748" x2="45.4302" y2="232.748"
                                      stroke={busdetails1.bus_type_status === "luxury" ? "#393939" : "#1F4B7F"} stroke-width="0.2"/>
                                    <path
                                    ...
                                    <path
                                      ...
                                      fill={busdetails1.bus_type_status === "luxury" ? "#393939" : "#1F4B7F"}/>
                                    <mask id="path-9-inside-2_6794_2554" fill="white" > <path d="M28.01 26.7649H29.1631V108.636H28.01V26.7649Z" /></mask>
                                    <path
                                      ...
                                      fill={busdetails1.bus_type_status === "luxury" ? "#393939" : "#1F4B7F"} mask="url(#path-9-inside-2_6794_2554)" />
                                    <g clip-path="url(#clip0_6794_2554)">
                                      ...
                                      <path
                                        ...
                                        fill="#465A61" /></g>
                                    <defs> <clipPath id="clip0_6794_2554"><rect width="30" height="30" fill="white"  transform="translate(13.5865 0.132812)"/></clipPath> </defs>
                                  </svg>
                                </div>
                              </span>
                              </div>
                      ...
                      items={[
                        {
                          ...
                          children: (
                            <div style={{
                              backgroundColor:
                              busdetails1.bus_type_status === "luxury"? "#FFEEC9": "white",
                            }}>
                                ...
                                <Formik
                                  initialValues={{
                                    ...
                                    mobile: mobileInput &&
                                      ...
                                      mobileInput !== "null" ? mobileInput: "",
                                    user_name: selectedSeats1.map((seat, index) =>travelerDetails[index]?.user_name) || "",
                                    age: selectedSeats1.map(
                                      ...
                                      <div class="flex flex-col md:flex-row md:items-center md:gap-[1vw] gap-[4vw] md:mb-[1vw] mb-[3vw] md:px-[0vw] px-[2vw] pt-[1vw]">
                                        ...
                                        <div className="flex items-center">
                                          <Field
                                            ...
                                            // }
                                            className={`${!isSubmitting || !enableInput? `cursor-pointer` : "cursor-not-allowed"
                                          ...
                                          <Field
                                            ...
                                            className={`${
                                              !isSubmitting || !enableInput? `cursor-pointer`: "cursor-not-allowed"
                                      ...
                                      <div className="grid md:grid-row-4 w-full h-full gap-[1vw] mt-[2vw] md:mt-[0vw] md:px-[0vw]">
                                        <div
                                          ...
                                          {Object.entries(seatDetails1).length > 0 &&
                                            Object.entries(seatDetails1).map(([seatNumber, seatDetail],index) => (
                                                <>
                                                    ...
                                                    <div class="grid grid-cols-4 grid-flow-row">
                                                      ...
                                                      <div className="ml-[-5.42vw]">
                                                        <Field
                                                          ...
                                                          onChange={(e) => {
                                                            handleChange(e);
                                                            setFieldValue(`user_name_${index}`,e.target.value);
                                                            setTravelerDetails(
                                                              (prevDetails) => ({
                                                                ...prevDetails,[index]: {
                                                                  ...prevDetails[index],
                                                          ...
                                                          className={`${
                                                            !isSubmitting || !enableInput ? `cursor-pointer`
                                                              : "cursor-not-allowed"
                                                      ...
                                                      <div className="ml-[5.2vw]">
                                                        <Field
                                                          ...
                                                          onChange={(e) => {
                                                            handleChange(e);
                                                            setFieldValue( `age_${index}`, e.target.value);
                                                            setTravelerDetails(
                                                              (prevDetails) => ({...prevDetails,[index]: {
                                                                  ...prevDetails[ index],
                                                                  age: e.target.value,
                                                                  seat: seatDetail.Seat,},
                                                              }));
                                                      ...
                                                      <div className="ml-[-0.1vw]">
                                                        ...
                                                        <span>
                                                          {!travelerDetails[index]?.user_name && passengerdatalist?.length > 0 &&
                                                          !travelerDetails[index]?.age ? (
                                                            passengerDropDown ===`${index}` ? (
                                                              <IoCaretUpSharp onClick={() =>toggleDropDown(`${index}`)}
                                                                color={
                                                                  busdetails1.bus_type_status ==="luxury" ? "#393939"
                                                                    : colorcode.theme}
                                                            ...
                                                            <IoIosCloseCircle
                                                                onClick={() => {
                                                                      ...
                                                                      setTravelerDetails((prevDetails) => ({...prevDetails,[index]: {
                                                                      ...prevDetails[index],
                                                                      user_name: undefined,
                                                                      age: undefined, },
                                                                  }));
                                                                    setFieldValue(`user_name_${index}`, undefined);
                                                                    setFieldValue(`age_${index}`, undefined);}}
                                                                  color={busdetails1.bus_type_status === "luxury" ? "#393939" : colorcode.theme}
                                                                  disabled={enableInput}
                                                                  className={`ml-[12vw] mt-[-2.5vw] ${ !isSubmitting || !enableInput ? "cursor-pointer" : "cursor-not-allowed"}`}
                                                                 size={"1.5vw"} />
                                                              )}
                                                        </span>
                                                      </div>
                                                  ...
                                                  {passengerDropDown ===
                                                    `${index}` && passengerdatalist?.length > 0 ? (
                                                    <div
                                                      style={{
                                                        borderColor:
                                                          busdetails1.bus_type_status ==="luxury"? "#393939"
                                                    ...
                                                    >
                                                      <div className="min-h-[4vw] max-h-[6.5vw] overflow-y-auto">
                                                        {passengerdatalist?.length > 0 && passengerdatalist.filter((passenger) => {
                                                                const seatStatus = seatDetails1[selectedSeats1[index]]?.Status;
                                                                // Filter based on seat status
                                                                if (seatStatus ==="AFF") {
                                                                  return ( passenger.gender ==="female");
                                                                } else if (seatStatus ==="AFM" ) {
                                                                  return (passenger.gender ==="male");
                                                                } else if ( seatStatus ==="AFA"
                                                                ) {
                                                            ...
                                                            .map((passenger,idx ) => (
                                                                <div
                                                                  onClick={(e) => {
                                                                    setFieldValue(`passenger_name_${index}`,passenger.passengerName);
                                                                    setTravelerDetails((prevDetails) => ({ ...prevDetails,[index]:
                                                                          { ...prevDetails[getTabIndex],
                                                                            user_name:passenger.passengerName,
                                                                            age: passenger.age,},})
                                                                    );
                                                                    handlePassengerSelect(e,passenger,index,setFieldValue);
                                                                  }}
                                                                  className={`grid grid-cols-3 gap-[8vw] items-center px-[3vw] py-[0.7vw] border-b-[0.1vw] mx-[0.3vw] ${
                                                                    busdetails1.bus_type_status === "luxury" ? "text-[#393939] border-b-[#393939]" : 
                                                                    "text-[#1F487C] border-b-[#adadad]" } hover:bg-gray-200 hover:rounded-sm`}
                                                                  key={idx}
                                                                >
                                                                  <div
                                                    ...
                                                    <span className="md:hidden block">
                                                      ...
                                                      >
                                                        ...
                                                        <div className="flex flex-col gap-y-[4vw]">
                                                          <div className="flex flex-row">
                                                            <div className="relative">
                                                              <Field
                                                                ...
                                                                value={travelerDetails[index]?.user_name ||values[`user_name_${index}`] ||""}
                                                                onChange={(e) => {
                                                                  handleChange(e);
                                                                  setFieldValue( `user_name_${index}`,e.target.value);
                                                                  setTravelerDetails((prevDetails) => ({...prevDetails,[index]: {
                                                          ...
                                                          !travelerDetails[index ]?.age? (
                                                            ...
                                                            <IoIosCloseCircle
                                                              onClick={() => {
                                                                ...
                                                                setTravelerDetails( ( prevDetails) => ({ ...prevDetails,
                                                          ...
                                                          {passengerDropDown === `${index}` && passengerdatalist?.length > 0 ? (
                                                               <div
                                                                style={{
                                                                borderColor: busdetails1.bus_type_status === "luxury" ? "#393939" : colorcode.theme,
                                                                }}
                                                                          ...
                                                                          onClick={(e) => {
                                                                           ...
                                                                           setTravelerDetails((prevDetails) => ({ ...prevDetails,[index]: {
                                                                            ...
                                                                            className={`grid grid-cols items-center px-[2vw] py-[1.9vw] border-b-[0.1vw] ${
                                                                              busdetails1.bus_type_status === "luxury" ? "text-[#393939] border-b-[#393939]" : 
                                                                              "text-[#1F487C] border-b-[#adadad]" } hover:bg-gray-200 hover:rounded-sm`} key={idx} >
                                                                    <div className={`flex font-medium text-center ${
                                                                          busdetails1.bus_type_status === "luxury" ? "text-[#393939]" : "text-[#1F487C]"
                                                                              }`}>
                                                                          {passenger.user_name} - (Age : {passenger.age}/{capitalizeFirstLetter(passenger.gender)})
                                                                   </div>
                                                                   </div>
                                                                  ))}
                                                             </div>
                                                          ...
                                                          <div className="">
                                                        <button
                                                          disabled={enableInput ||seatDetails1[selectedSeats1[index]]?.Status !== "AFA" }
                                                          type="button"
                                                          name="gender"
                                                          style={{
                                                            background:
                                                              travelerDetails[index ]?.gender ==="male" || !travelerDetails[index]
                                                                ? busdetails1.bus_type_status ==="luxury" ? "#393939"
                                                                  : busdetails1.bus_type_status ==="regular"
                                                                  ? colorcode.theme : ""  : "#ffffff",
                                                            color:
                                                              travelerDetails[index]?.gender !=="male" &&
                                                              travelerDetails[index]
                                                                ? busdetails1.bus_type_status ==="luxury" ? "#393939"
                                                                  : busdetails1.bus_type_status ==="regular" ? colorcode.theme
                                                                  : ""
                                                                : "",
                                                            borderColor:
                                                              travelerDetails[index]?.gender ==="male" || !travelerDetails[index]
                                                          ...
                                                          onClick={() =>
                                                            setTravelerDetails(
                                                              (prevDetails) => ({...prevDetails, [index]: {...prevDetails[index],
                                                                  gender:"male",
                                                                  seat: seatDetail.Seat,
                                                                },
                                                              }))}>
                                                      ...
                                                      <button
                                                          ...
                                                          style={{
                                                            background:
                                                              travelerDetails[index]?.gender ==="female" ||
                                                              !travelerDetails[ index ]
                                                                ? busdetails1.bus_type_status ==="luxury" ? "#393939"
                                                                  : busdetails1.bus_type_status ==="regular"? colorcode.theme : "#ffffff"
                                                                : "#ffffff",
                                                            color:
                                                              travelerDetails[ index]?.gender !=="female" &&
                                                              travelerDetails[index]
                                                                ? busdetails1.bus_type_status ==="luxury"? "#393939"
                                                                  ...
                                                                  ? colorcode.theme: "" : "",
                                                            borderColor:
                                                              travelerDetails[ index ]?.gender ==="female" || !travelerDetails[index]
                                                                ? busdetails1.bus_type_status ==="luxury" ? "#393939"
                                                                  : busdetails1.bus_type_status ==="regular"
                                                                  ? colorcode.theme : ""
                                                                : "",
                                          ...
                                          <div className="flex md:flex-row flex-col md:pt-[2vw] pt-[4vw] md:items-center md:justify-between py-[2vw] md:py-[0vw] px-[2vw] md:px-[0vw]">
                                            ...
                                            <div className="flex justify-end md:gap-x-[0vw] gap-x-[6vw] items-center">
                                              ...
                                              <button
                                                ...
                                                className={`${
                                                  (!isSubmitting && isValid && termschecked) ||
                                                  !enableInput ? "cursor-pointer" : "cursor-not-allowed"}  
                                  md:w-[18vw] w-full h-[8vw] md:h-[2.5vw] rounded-[2vw] md:rounded-[0.5vw] ml-[1vw]`}
                                                ...
                                                onClick={() => {
                                                  ...
                                                  //     : values.mobile
                                                  // );
                                                  console.log("passenger detail",travelerDetails, showPrice);
                                                }}
                                              >
                    ...
                    >
                      ...
                      <div className="px-[1vw] py-[1vw]">
                        <div className="grid grid-cols-6 w-full h-[18vw] relative">
                            ...
                            <div className="grid grid-rows-7 w-full h-full">
                              <div className="row-span-3">
                                ...
                                "DD MMM"
                                        ...
                                        {dayjs(ticketDetail?.departure_date).format("DD MMM")}
                                      </p>
                                      <p
                                        className={`${
                                          busdetails1.bus_type_status ==="luxury"? "text-[#393939]"
                                  ...
                                  <div className="col-span-1">
                                    <div className="flex flex-col text-right pr-[1vw]">
                                      <p className={`${
                                        ...
                                        // style={{ color: colorcode.theme }}
                                        >
                                        {dayjs( ticketDetail?.arrival_date).format("DD MMM")}
                                      </p>
                                      <p
                                        className={`${
                                          busdetails1.bus_type_status ==="luxury"? "text-[#393939]"
                              ...
                              <div className="row-span-2 flex justify-between px-[1vw]  ">
                                <div className="flex flex-col  ">
                                  ...
                                  <p
                                    className={`${busdetails1.bus_type_status === "luxury"
                                        ? "text-[#393939]"
                                        : "text-[#1F487C]"
                                     ...
                                     {selectedRoutes1?.arri_route?.length > 25 ? (
                                          <Tooltip
                                            ...
                                            color={
                                              busdetails1.bus_type_status ==="luxury"? "#393939" : colorcode.theme}
                                          >
                                            {`${selectedRoutes1?.arri_route?.slice(0,20)}... (${ticketDetail?.Droppimg_Time})`}
                                          </Tooltip>
                                        ) : (
                                          `${selectedRoutes1?.arri_route?.slice(0,20)} (${ticketDetail?.Droppimg_Time})`)}
                                  </p>
                          ...
                          <span className="absolute md:block hidden left-[15.2vw]">
                                <div className="h-full py-[0.5vw]">
                                  <svg className="md:h-[15.3vw] md:w-[4.2vw]"
                                    viewBox="0 0 58 233" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="24.7695" y="110.186" width="7.77032" height="7.77032" rx="3.88516"
                                      stroke={busdetails1.bus_type_status === "luxury" ? "#393939" : "#1F4B7F"} stroke-width="2.30622"/>
                                    <mask id="path-2-inside-1_6794_2554" fill="white"> <path d="M28.0771 117.016H29.2303V203.374H28.0771V117.016Z" /> </mask>
                      ...
                      <div className="h-auto w-full px-[1vw] pt-[1vw]">
                        <div className="grid grid-row-3 w-full h-full gap-[1vw]">
                          <div
                            className={`${
                              busdetails1.bus_type_status === "luxury" ? "border-[#393939]"
                                : "border-[#1F487C]"
                                                ...
                                                : {
                                                    ...
                                                    color:
                                                      busdetails1.bus_type_status ==="luxury"
                                                        ...
                                                        ? colorcode.theme : "",
                                                    borderColor:
                                                      travelerDetails[index]?.gender === "male" || !travelerDetails[index] ? busdetails1.bus_type_status === "luxury"
                                                          ? "#393939" : colorcode.theme: "",}),
                                            }}
                                            className={`${
                                              passenger?.gender === "male" ? busdetails1.bus_type_status ==="luxury"
                                              ...
                                              ...(passenger?.gender === "female"? {
                                                    ...
                                                    color:
                                                      busdetails1.bus_type_status ==="luxury"
                                                        ? "#393939": colorcode.theme,
                                                    borderColor:
                                                      travelerDetails[index]?.gender === "female" || !travelerDetails[index]? busdetails1.bus_type_status === "luxury"
                                                          ? "#393939": colorcode.theme : "",}),
                                            }}
                                            className={`${
                                              passenger?.gender === "female"
                              ...
                              <div className="col-span-2 flex relative">
                                <div
                                  ...
                                  <p
                                    ...
                                    style={{
                                      // color: colorcode.theme,
                                      borderColor: busdetails1.bus_type_status === "luxury"? "#393939"
                                          : colorcode.theme,}}>+91
                                  </p>
                                </div>
                                <div
                          ...
                          <div
                            className={`${ busdetails1.bus_type_status === "luxury"? "border-[#393939]" : "border-[#1F487C]"
                            } border-dashed border-2`}></div>
                        </div>
                      </div>
                      <div className="flex items-center justify-between pl-[1vw] pr-[2vw] pt-[1vw]">
                        ...
                        >
                          <div
                            ...
                            style={{
                              borderColor:
                                busdetails1.bus_type_status === "luxury" ? "#39393983"
                                  : colorcode.gradient,
                            }}
                          >
                            <div
