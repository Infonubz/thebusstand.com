...
const Policy = ({ bus_type_status, busType }) => {
            ...
            >
              <span
                className={`${
                  isToggleSwitch === "CDCP"
                    ? "text-[#F6F6F6]"
                    : busType === "regular" ? "text-[#1F4B7F]" : busType === "luxury"? "text-[#393939]" : "text-[#F6F6F6]"
                }  text-[1.3vw]`}
              >
            ...
            <div className="py-[2vw]">
              {Travel.map((trp) => (
                <div className="flex items-center gap-x-[2vw] py-[0.5vw]">
                  ...
                  } w-[2vw] h-[2vw] `}>{trp.travel_img}</div>
