...
const amenityIcons = {
    Blankets: <BiSolidBlanket color='#1F487C' size="1.5vw" />,
    "Charging Point": <BsPlug color='#1F487C' size="1.5vw" />,
    "Emergency exit": (
        <svg xmlns="http://www.w3.org/2000/svg" color='#1F487C' width="1.5vw" height="1.5vw" viewBox="0 0 24 24">
    ...
    "Live Bus Tracking": <MdMyLocation color='#1F487C' size="1.5vw" />,
    Pillow: <BiSolidBlanket color='#1F487C' size="1.5vw" />,
    "Reading Light": <MdOutlineLight color='#1F487C' size="1.5vw" />,
    "Water Bottle": <GiWaterBottle color='#1F487C' size="1.5vw" />,
    "CC Camera": <BiCctv color='#1F487C' size="1.5vw" />,
    "First Aid Box": <FaFirstAid color='#1F487C'size="1.5vw" />,
    "M Ticket": <IoTicketOutline color='#1F487C' size="1.5vw" />,
    BedSheet: (
        <svg xmlns="http://www.w3.org/2000/svg" color='#1F487C' width="1.5vw" height="1.5vw" viewBox="0 0 24 24">
...
const amenityIconsMobile = {
    ...
    "Emergency exit": (
        <svg xmlns="http://www.w3.org/2000/svg" color='#1F487C' width="2.5vw" height="2.5vw" viewBox="0 0 24 24">
            <path fill="currentColor" d="M13.34 8.17c-.93 0-1.69-.77-1.69-1.7a1.69 1.69 0 0 1 1.69-1.69c.94 0 1.7.76 1.7 1.69s-.76 1.7-1.7 1.7M10.3 19.93l-5.93-1.18l.34-1.7l4.15.85l1.35-6.86l-1.52.6v2.86H7v-3.96l4.4-1.87l.67-.08c.6 0 1.1.34 1.43.85l.86 1.35c.68 1.21 2.03 2.03 3.64 2.03v1.68c-1.86 0-3.56-.83-4.66-2.1l-.5 2.54l1.77 1.69V23h-1.69v-5.1l-1.78-1.69zM21 23h-2V3H6v13.11l-2-.42V1h17zM6 23H4v-3.22l2 .42z" />
        </svg>
    ),
...
const LiveTracking = ({ trackingCount, setTrackingCount, amenities }) => {
    ...
    return (
      <>
        <div className='bg-[#F6F6F6] w-full px-[1vw] md:block hidden'>
            <div className="w-full grid grid-flow-col grid-rows-3 gap-x-[2vw] gap-y-[1vw] py-[1.5vw] overflow-x-auto overflow-y-hidden">
                {sortedAmenities.map((amenity, idx) => (
                    <div key={idx} className='flex items-center text-[1vw] gap-x-[1vw] '>
