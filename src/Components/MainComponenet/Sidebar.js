      ...
      >
        <div className="border-[0.1vw] border-[#c9c9c9] h-full  pb-[8vw] overflow-y-scroll scrollbar-hide  rounded-[0.5vw]">
                  ...
                  {pickuppointlist.map((item, i) => (
                    <div className="flex items-center justify-between" key={i}>
                      <div className="flex items-center my-[0.25vw]">
                        ...
                        />
                        <span className=" text-[1vw]">{item.place}</span>
                      </div>
                      <div>
                        <span className="text-[0.8vw]">{`(${item.count / 8
                          })`}</span>
                      </div>
                    </div>
                  ))}
          ...
          <div className="">
            ...
            <div>
              {boolean.amenities ? (
                <div className="flex flex-wrap gap-[0.5vw] py-[0.6vw] px-[0.6vw]">
                  {amenitieslist.slice(0, 5).map((item, i) => (
                    ...
                    //   } py-[0.5vw] px-[1vw] rounded-[0.6vw]  cursor-pointer`}
                    //   onClick={() => handleAmenities(item.place)}
                    // >
                    //   <p className="text-[1vw]">{`${item.place} (${
                    //     item.count / 8
                    //   })`}</p>
                    // </button>
                    // null
