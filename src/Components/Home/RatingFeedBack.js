                    ...
                    <Form onSubmit={handleSubmit}>
                        {value > 0 ? (
                            <div>
                                <div className="overflow-hidden w-full h-[34.25vw] rounded-lg py-[1.5vw] px-[2.5vw]">
                                    <span className='text-[#1F487C] font-bold text-[1.5vw]'>Enjoy our Website?</span>
                                    <div className='py-[1vw]'>
                                        <p className='text-[1.25vw] text-[#1F487C] font-semibold text-center'>Rate your Experience with the TBS App</p>
                                    </div>
                                    <div className='text-center'>
                                        ...
                                        <div className='flex gap-[1vw] items-center justify-center py-[1vw]'>
                                            ...
                                            <span style={{ color: getColorForValue(value), fontSize: '1.5vw' }}>{value}</span>
                                            <span style={{ color: getColorForValue(value), fontSize: '1.5vw' }}> - </span>
                                            <span style={{ color: getColorForValue(value), fontSize: '1.5vw' }}>{desc[Math.floor(value) - 1]}</span>
                                        </div>
                                        <div>
                            ...
                            <div>
                                ...
                                <div className='px-[2vw]'>
                                    <div className='flex flex-col items-center justify-center'>
                                        <span className='text-[1.5vw] text-[#1F487C] font-bold'>Rate your experience with thebusstand.com</span>
                                        <span className='text-[1.5vw] text-[#1F487C] font-bold'>(TBS)</span>
                                    </div>
                                        ...
                                        <div className='grid grid-cols-2 gap-[0.5vw] py-[2vw]'>
                                            <div>
                                                <input
                                                    ...
                                                    className="p-2 border border-gray-300 rounded-2xl outline-none w-full bg-[#D0E5FF4D] text-[#1F487C] h-[3vw] text-[1.2vw]"
                                                />
                                            </div>
                                            <div>
                                                <input
                        ...
                        <div className='grid grid-cols-2 items-center pb-[2vw] px-[1vw]'>
                            ...
                            <div className='flex justify-center'>
                                <button type='submit' className='bg-[#1F487C] text-[1.2vw] text-white font-bold rounded-full w-3/4 h-[2.5vw]'>
                                    Submit
                                </button>
                            </div>
                        </div>
