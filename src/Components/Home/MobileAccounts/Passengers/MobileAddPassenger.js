    ...
    return (
        <>
            <div className="w-screen h-[15vw] bg-[#1F487C] flex items-center justify-center">
                <div className="col-span-2 " onClick={prevStep}><IoIosArrowRoundBack color="white" size="10vw" /></div>
                <div className="px-[2vw] text-[4.5vw] text-white font-bold flex gap-[2vw]"><p onClick={() => navigate('/dashboard')}>Home</p><p>{`>`}</p><p onClick={prevStep}>My Account</p><p>{`>`}</p><p>Add Passenger</p></div>
            </div>
            <div className="py-[2vw] px-[2.5vw]">
                ...
                >
                    {({
                        ...
                        >
                            <div className="flex flex-col gap-y-[8vw] pb-[6vw]">
