                ...
                >
                  ...
                  <span className="font-bold text-[4vw] md:text-[1.1vw]  text-[#1F487C]">
                    ...
                    <ErrorMessage
                      name="gender"
                      component="div"
                      className="text-red-500 bottom-[-2.5vw] md:bottom-[-.8vw] md:text-[0.8vw] text-[2.1vw]  absolute"
                    />
                  </div>
                </div>
                <div className="relative md:pb-[0.5vw]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 py-[1vw] my-[2vw] md:my-[0vw] gap-y-[6vw] md:gap-y-[2.5vw]">
                    <div className="relative z-0 w-full">
                      ...
                      <div className="absolute top-[10vw] md:top-[3vw] left-[0vw] md:left-[1.5vw] md:text-[0.8vw] text-[2.1vw] text-[#1F487C] opacity-50">
                    ...
                    <div className="relative z-0 w-full">
                      ...
                      <label
                        htmlFor="email"
                        className={`absolute text-[4.5vw] md:text-[1.2vw] text-[#1F487C] duration-300 transform -translate-y-[0.2vw] scale-75 top-[2vw] md:top-[0.8vw] md:left-[0.4vw] left-[2vw] origin-0 bg-white px-[0.2vw] peer-focus:left-[2vw] md:peer-focus:left-[0.6vw] peer-focus:text-[#1F487C] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-[0.4vw] peer-placeholder-shown:text-[vw] peer-focus:text-[3.2vw] md:peer-focus:text-[1vw] peer-focus:scale-75 peer-focus:-translate-y-[5vw] md:peer-focus:-translate-y-[1.5vw] ${
                          values.email
                      ...
                      <ErrorMessage
                        name="email"
                        component="div"
                        className="text-red-500 md:text-[0.8vw] text-[2.1vw] absolute md:top-[2.8vw] top-[10vw]"
                      />
                    </div>
                    <div className="relative z-0 w-full">
                      <Field
                      ...
                      <ErrorMessage
                        name="phone"
                        component="div"
                        className="text-red-500 md:text-[0.8vw] text-[2.1vw] absolute md:top-[2.9vw] top-[10vw]"
                      />
                    </div>
                  </div>
                </div>
