          ...
          >
                ...
                <div className="col-span-2 w-[100%] h-full flex">
                  <div className="w-[100vw] h-full items-center justify-center flex flex-col">
                    ...
                    <div className="flex flex-col h-[40%] items-center">
                      ...
                      >
                        {ticketDetails?.operator_name?.length > 23 ? (
                          <Tooltip
                            placement="top"
                            title={ticketDetails?.operator_name}
                          ...
                          >
                            {`${ticketDetails?.operator_name?.slice(0, 22)}...`}
                          </Tooltip>
                        ) : (
                          `${ticketDetails?.operator_name?.slice(0, 22)}`
                        )}
                      </p>
                      <p className="text-[#1F487C] text-[0.8vw]">
                        {ticketDetails?.Bus_Type?.length > 25 ? (
                          <Tooltip
                            placement="top"
                            title={ticketDetails?.Bus_Type}
                            className="cursor-pointer"
                            color={
                              ticketDetails.bus_type_status === "luxury"
                                ? "#393939"
                          ...
                          >
                            {`${ticketDetails?.Bus_Type?.slice(0, 24)}...`}
                          </Tooltip>
                        ) : (
                          `${ticketDetails?.Bus_Type?.slice(0, 24)}`
                        )}
                      ...
                      <div className="grid grid-cols-4">
                        ...
                        <div className="col-span-2 flex-col mt-[0.5vw] items-center w-full justify-center">
                          ...
                          >
                            ...
                            <div className="absolute pb-[0.8vw]">
                        ...
                        <div className="text-[1.1vw] font-semibold">
                          ...
                          >
                            {ticketDetails?.passenger?.length > 0 ? (
                              ticketDetails?.passenger?.map((v, index) => (
                                <p
                                  key={index}
                                ...
                                >
                                  {v.seat}
                                  {index <
                                    ticketDetails?.passenger?.length - 1 && ","}
                                </p>
                              ))
                            ) : (
                              <p
                    ...
                    <div className="row-span-2 flex px-[1vw] justify-between ">
                      <div className="flex flex-col  ">
                        ...
                        >
                          ...
                          {`${ticketDetails?.Dropping_Point} (${ticketDetails?.arrival_time}) `}
                        </p>
                      </div>
            ...
            <div className="flex items-center justify-between pl-[1vw] pr-[2vw] pt-[1vw]">
              ...
              <div className="cursor-pointer pr-[2vw] pb-[2vw]">
                <div
                  className="border-[.6vw] absolute h-[6vw] w-[6vw] rounded-[50%]"
                  style={{
                    borderColor:
                      ticketDetails.bus_type_status === "luxury"
                        ? "#39393983"
