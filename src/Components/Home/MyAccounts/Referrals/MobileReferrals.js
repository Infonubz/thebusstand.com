            ...
            <div className='bg-[#E5FFF1] min-h-screen max-h-auto w-full'>
                <div className="fixed top-0 w-screen left-0 right-0 bg-[#E5FFF1] z-10">
                    ...
                    <div className="">
                        ...
                        >
                            <label className="text-white text-[8vw] font-bold absolute top-[3vw] left-[39vw] opacity-15">Referrals</label>
                            <label className="text-white text-[5vw] font-bold absolute top-[6vw] left-[45vw]">Referrals</label>
                ...
                <div className="relative">
                    ...
                    <div className="absolute top-[30vw]">
                        ...
                        <div className="mt-[2.5vw]">
                            ...
                            {currenttab == 1 ? (
                                <>
                                    <div className="h-[35vh] overflow-y-scroll mt-[2vw] Legal-Information-Mobile">
