    ...
    <div>
      ...
      <div className="relative h-[45vw] bg-[#E5FFF1]" style={{ zIndex: 1 }}>
        ...
        >
          ...
          <div
            className={`absolute top-[1.25vw] left-[48.5vw] text-white text-[2vw] font-bold transition-transform duration-500 ease-in-out ${
              currenttab === 1
                ? "translate-x-0"
                : currenttab === 2
                ? "-translate-x-0"
        ...
        <div className="absolute top-[5vw] left-[4vw]">
          ...
          >
            <label className="font-bold text-[1.3vw] cursor-pointer">
              Privacy Policy
            </label>
          </div>
        </div>
        ...
        <div className=" absolute left-[25vw] top-[5vw] cursor-pointer">
