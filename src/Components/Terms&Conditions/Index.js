        ...
        <div>
            ...
            <div className="relative h-[45vw] bg-[#E5FFF1]" style={{ zIndex: 1 }}>
                ...
                <div className="absolute top-[15vw] left-[4vw]">
                    <div
                        className={`cursor-pointer w-[18vw] h-[5vw] rounded-bl-[1vw] rounded-br-[1vw] flex items-center pl-[4vw] border-l-[0.1vw] border-r-[0.1vw] border-b-[0.1vw] border-[#1F487C] transition-colors duration-300 ${currenttab === 3 ? "bg-[#1F487C] text-white" : "bg-white text-[#1F487C]"
                            }`}
