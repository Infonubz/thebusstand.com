    ...
    return (
        <>
            <div className=" min-h-screen max-h-auto w-full bg-[#E5FFF1]">
                ...
                <div
                    className="relative md:h-[110vh] h-[100%] bg-[#E5FFF1]"
                    style={{ zIndex: 1 }}
                >
                    <div
                    ...
                    >
                        <label className="absolute left-[39vw] md:left-[53.5vw] top-[2vw] md:top-[0.1vw] text-[7vw]  md:text-[4vw] text-white font-bold opacity-20">
                            {`Routes`}
                        </label>
                        <label className="absolute left-[43vw] md:left-[57vw] top-[3.5vw] md:top-[2vw] text-[5vw]  md:text-[2vw] text-white font-bold">
                            {"Routes"}
                        </label>
                    ...
                    <div className="grid grid-cols-6 gap-[18vw]">
                        ...
                        <div className="col-span-5">
                            <div className="md:block hidden absolute top-[7vw] pl-[3vw]">
                                <div
                                    className="  bg-white border-solid border px-[1vw] border-b-[#1F487C] w-[76vw] 
        ...
        `}
                            ...
                            <div className={`absolute top-[9.5vw] pl-[3vw]`}>
                                <div
                                    className={`bg-white md:w-[76vw] w-[94vw] h-[87vh] md:h-[29vw] relative rounded-[3vw] md:rounded-[1vw] shadow-lg shadow-gray-300`}
                                >
                                    <div
        ...
        `}
                                    ...
                                    <div className="block md:hidden">
                                        <div
                                            className={`border border-1 border-[#1F487C] w-[88vw] flex flex-col h-auto rounded-[2vw] mt-[6vw] ml-[3vw] py-[2vw]`}
                                        >
                                            <div className="flex">
                        ...
                        /> */}
                                    ...
                                    <div className="block md:hidden">
                                        <div className="flex ml-[20vw] bottom-0 fixed">
                                            <Pagination
                                                current={currentPage}
