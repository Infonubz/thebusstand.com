...
import { GetOperators, OperatorFilters } from "../../../../../Api-TBS/Dashboard/Dashboard";
...
export default function Operators() {
    ...
    return (
        <>
            <div className={`min-h-screen max-h-auto max-w-screen bg-[#E5FFF1] overflow-clip`}>
                <div className="">
                    <Navbar_One />
                </div>
                <div
        ...
        `}
                            ...
                            <div className={`flex pl-[0.1vw]`}>
                                <div className={`bg-[#1F487C] rounded-t-[0.5vw] flex w-[12.5vw]  items-center gap-[0.5vw]`}>
                                    <BiSolidSearch
                                    ...
                                    <input
                                        type="text"
                                        className={`bg-[#1F487C] w-full text-[1.25vw] text-white outline-none px-[0.1vw]`}
