  ...
  const Travel = [
    {
      travel_img:
        ...
        // </svg>
        LuxuryFind(bus_type) === true
          ? SVG?.mobile_luxury_child
          : SVG?.mobile_normal_child,
    ...
    },
    {
      travel_img:
        ...
        // </svg>
        LuxuryFind(bus_type) === true
          ? SVG?.mobile_luxury_luggage
          : SVG?.mobile_normal_luggage,
    ...
    },
    {
      travel_img: (
        <IoPawOutline
          ...
          color={
            // busType === "luxury"
            LuxuryFind(bus_type) === true ? "#393939" : "#1F4B7F"
          }
        />
      ),
      parent: "Pets Policy",
    ...
    },
    {
      travel_img:
        ...
        // </svg>
        LuxuryFind(bus_type) === true
          ? SVG?.mobile_luxury_liquor
          : SVG?.mobile_normal_liquor,
    ...
    },
    {
      travel_img:
        ...
        // </svg>
        LuxuryFind(bus_type) === true
          ? SVG?.mobile_luxury_time
          : SVG?.mobile_normal_time,
          ...
          <div ref={componentRef} id="capture" className={`h-auto w-full`}>
            <div className={`h-auto w-full`}>
              {drawername === "Amenities" ? (
                ...
                <>
                  <div
                    className={`text-[4vw] grid grid-cols-2 p-[2vw] gap-[3vw] ${
                          ...
                          BOARDING
                              ...
                              {boarding?.map((item) => {
                                ...
                                if (parts.length >= 3) {
                                  ...
                                  return (
                                    <div
                                      className="flex gap-x-[1vw] pb-[.7vw] items-center"
                                      key={id}
                                    >
                                      <div
                                        className={`${
                                          ...
                                          LuxuryFind(bus_type) === true
                                            ? "text-[#393939]"
                                            : "text-[#1F487C]"
                                        } text-[4vw] cursor-pointer flex items-center gap-x-[2vw]`}
                                      >
                            ...
                            <div className="flex flex-col gap-y-[2.5vw] px-[2vw]">
                              {dropping?.map((item) => {
                                ...
                                if (parts.length >= 3) {
                                  ...
                                  return (
                                    <div
                                      className="flex gap-x-[1vw]  items-center"
                                      key={id}
                                    >
                                      <div
                                        className={`${
                ...
                <div className={` h-auto`}>
                  <div className="flex w-full">
                    <button
                      className={`w-[50vw] h-[7vw] flex border-[0.15vw] rounded-l-[1vw]  px-[0.3vw] justify-center gap-[0.5vw] items-center ${
                        isToggleSwitch === "CDCP"
                          ? // busType === "luxury"
                            LuxuryFind(bus_type) === true
                    ...
                    <button
                      className={`w-[50vw] h-[7vw] flex border-[0.15vw]  rounded-r-[1vw] px-[0.1vw] justify-center gap-[0.5vw] items-center ${
                        isToggleSwitch === "TRP"
                          ? // busType === "luxury"
                            LuxuryFind(bus_type) === true
                            ? "bg-[#393939] border-[#393939]"
                        ...
                        {cancelPolicy === undefined || null ? (
                          ...
                          <>
                            <div className="w-full gap-[1vw] col-span-8">
                              ...
                              <div
                                className={`text-[3vw] flex flex-col gap-y-[2vw] mt-[2vw] ${
                                  // busType === 'luxury'
                                  LuxuryFind(bus_type) === true
                                    ? "text-[#393939]"
                                    : "text-[#1F4B7F]"
