...
export default function Policies({ policies, busPrice, busType, bus_type }) {
    ...
    const Travel = [
        {
            travel_img: (
                LuxuryFind(bus_type) === true ? SVG?.luxury_child_policy : SVG?.normal_child_policy
                // <svg
                //     width="35"
                //     height="35"
                //     viewBox="0 0 43 42"
        ...
        {
            travel_img: (
                LuxuryFind(bus_type) === true ? SVG?.luxury_luggage_policy : SVG?.normal_luggage_policy
                // <svg
                //     width="35"
                //     height="35"
                //     viewBox="0 0 59 58"
        ...
        },
        {
            travel_img: (
                ...
                //     />
                // </svg>
                LuxuryFind(bus_type) === true ? SVG?.luxury_liquor_policy : SVG?.normal_liquor_policy
        ...
        },
        {
            travel_img: (
                ...
                //     />
                // </svg>
                LuxuryFind(bus_type) === true ? SVG?.luxury_time_policy : SVG?.normal_time_policy
