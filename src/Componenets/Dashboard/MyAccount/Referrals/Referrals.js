...
import referralnew from "../../../../Assets/Gif/referralnew.gif";
import referralMble from "../../../../Assets/Gif/CashBack_Mble.gif.gif";
...
import {
  GetRefferalCode,
  GetRefferalContent,
} from "../../../../Api-TBS/MyAccounts/Referral";
...
export default function ReferralsIndex() {
  ...
  console.log(spinning, 'spinning_spinning')
  const [visible, setVisible] = useState(false);
  const [modalIsOpen, setModalIsOpen] = useState(false);
  console.log(getCode, "get_code_get");
  ...
  //   } else {
  //     console.error(
  //       "Clipboard API is not available or referral code is missing."
  //     );
  //   }
  // };
  const [isCopied, setIsCopied] = useState(false);
  const handleCopy = () => {
    const referralCode = getCode?.referral_code;
    if (referralCode) {
  ...
  return (
    <>
      {spinning ? (
        ...
        <div className="bg-white md:shadow-lg md:shadow-gray-400 w-full rounded-[1vw]">
          <span className="relative">
            <img
              src={referralMble}
              alt="referralHeader"
              className="w-full block md:hidden rounded-t-[1.5vw]"
            // className="rotate-90"
            // style={{
            //   rotate: 90,
            // }}
            ...
            <div className="absolute font-mono text-[5.5vw] md:text-[1.8vw] top-[5vw] md:top-[3.3vw] left-[39vw] md:left-[29vw] text-[#ff0805] font-semibold">
              Upto
              <span className="text-[7vw] md:text-[2.8vw]">
                ₹{getContent?.referral_amount}
              </span>
            </div>
            <div className="absolute text-[3.5vw] md:text-[1.3vw] font-times font-serif bottom-[5vw] md:bottom-[1.8vw] left-[27.5vw] md:left-[26.5vw]">
              Refer to <span className="font-semibold">thebusstand.com</span>
            </div>
            <div className="absolute text-[3.5vw] md:text-[1.3vw] font-serif bottom-[.1vw] left-[32.5vw] md:left-[29vw]">
              Get Your Rewards !!!
            </div>
          </span>
          {/* <label>hi</label> */}
          ...
          <div className="flex flex-col pt-[3vw] md:pt-[0vw] md:flex-row items-center md:justify-between px-[3vw] py-[1vw]">
            <div className="flex bg-white shadow-lg shadow-grey-400 md:shadow-none p-[4vw] md:p-[0vw] items-center gap-[6vw] md:gap-[3vw]">
              <div className="flex flex-col">
                <label
                  className={`md:block hidden pt-[0.5vw] md:text-[1vw] ${getCode?.referral_code === null
                      ? "text-[2vw]"
                      : "text-[4vw]"
             ...
             arrowPointAtCenter></Popover> */}
                {getCode?.referral_code != null ? (
                  ...
                  <div className="">
                    <button
                      className="md:text-[1vw] text-[3.5vw]  text-white font-bold bg-[#04B9EF] md:px-[1vw] px-[1.5vw] md:py-[0.25vw] py-[0.75vw] md:rounded-[0.5vw] rounded-[1vw]"
                      onClick={() =>
            ...
            <div className="flex md:items-center gap-x-[22vw] mt-[6vw] md:gap-[5vw] md:mt-[0vw]">
              <button
                className={`${currenttab === 1 ? "border-b-[0.2vw] border-[#1F487C]" : ""
                  } text-[#1F487C] text-[4vw] md:text-[1.5vw] font-bold`}
          ...
          <div className="md:h-full h-[37.5vh] md:overflow-clip overflow-y-auto mt-[1vw] md:mt-0">
            {currenttab === 1 ? (
              <>
              ...
              <div className="flex items-center justify-end mt-[2vw] pr-[3vw]">
                <div className="flex flex-col md:p-[0vw] p-[8vw] w-screen md:w-[20vw]">
                 ...
                 bottom-3 md:static">
                  ...
                  <label
                    className={`text-[#1F487C] cursor-pointer text-[4.5vw] md:text-[1.2vw] md:pt-[1.5vw] pt-[10vw] text-center font-semibold md:pb-[1.2vw]`}
                    onClick={() => setModalIsOpen(true)}
                  >
                    Terms & Conditions
                  </label>
      ...
      >
        <div>
          <div className="flex h-[3vw] justify-center text-center">
            <label className="md:text-[1.4vw] text-[3.5vw] text-[#1F487C] font-bold">
              Terms & Conditions
            </label>
          </div>
          <div className="Legal-Information overflow-y-scroll w-full h-[29vw] px-[0.5vw] py-[1vw]">
            ...
            <div>
              <p className="md:text-[1vw] text-[3vw] text-[#1F487C]">
