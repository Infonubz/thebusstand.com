            ...
            <div className='bg-[#E5FFF1] min-h-screen max-h-auto w-full'>
                <div className="fixed top-0 w-screen left-0 right-0 bg-[#E5FFF1] z-10">
                    ...
                    <div className="">
                        ...
                        >
                            <label className="text-white text-[8vw] font-bold absolute top-[3vw] left-[42vw] opacity-15">Help</label>
                            <label className="text-white text-[5vw] font-bold absolute top-[6vw] left-[45vw]">Help</label>
                ...
                <div className="relative">
                    ...
                    <div className="absolute top-[30vw]">
                        ...
                        <div className="px-[3vw] overflow-y-scroll h-[71vh] border-b-[0.5vw] Legal-Information-Mobile">
                                    ...
                                    {({
                                        ...
                                        >
                                            <div>
                                                    ...
                                                    <div className="px-[1.5vw]">
                                                        <div className='flex flex-col gap-[4vw] pb-[5vw] pt-[1vw] w-full relative border-[0.1vw] bg-white border-[#1F487C] px-[3vw] rounded-2xl'>
                                                            ...
                                                            <div className=" flex items-center gap-[2vw] py-[1vw]">
                                                                ...
                                                                <label htmlFor="terms" className="text-[3vw] text-[#1F487C] cursor-pointer">I accept the terms and conditions</label>
                                                                <ErrorMessage
                                                                    name="terms"
                                                                    component="div"
                                                ...
                                                <div className='flex items-center justify-center py-[2vw] fixed bottom-0 w-full'>
