...
import MyBookingIndex from "./MyBookings/Index";
import LoginModalPopUp from "../../Common/Login-Modal/Modal";
        ...
        <div>
          ...
          <div className="relative h-screen bg-[#E5FFF1]">
            ...
            {!decrypid ?
              (
                <div className="px-[25%]">
                  <div className="flex flex-col items-center justify-center bg-white w-[100%] py-[2vw] rounded-[2vw] shadow-2xl gap-[3.5vw]">
                    <img src={Password} alt="password Login" className="w-[15vw] h-[15vw]" />
                    <span className="text-[2vw]"> Need to Log-In to Access Your Account</span>
                    <div
                      onClick={() => {
                        setLoginIsOpen(true)
                      }}
                      className="flex items-center justify-center bg-[#1F487C] text-white rounded-[1vw] text-[1.5vw] cursor-pointer w-[10vw] py-[0.5vw]"
                    >
                      Log-In
                    </div>
                  </div>
