      ...
      > */}
                    <div className="my-[4vw]">
                        ...
                        >
                            ...
                            >
                                <div
                                    className={`grid grid-cols-12 px-[2vw]`}
                                >
                       ...
                       */}
                            ...
                            <div
                                className={`h-auto flex flex-row items-center justify-center text-center w-full px-[1vw] pt-[2vw] ${ticket_Details?.bus_type_status === "luxury"
                                    ? "text-[#393939]"
                                    : "text-black"
                                    }`}
                            >
                            ...
                            <div className="px-[1vw] py-[3vw]">
                                <div className={`grid grid-cols-2 text-[4vw] font-bold ${ticket_Details?.bus_type_status === "luxury"
                                    ? "text-[#393939]"
                                    : "text-[#1F487C]"
                                    }`}>
