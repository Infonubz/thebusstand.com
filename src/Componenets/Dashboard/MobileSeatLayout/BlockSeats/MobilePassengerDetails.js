...
export default function MobilePassengerDetails({
  ...
  const selectedSeats1 = MobSelectedSeats;
  ...
  //     //   bookingId
  //     // );
  //     const response = await Abhibus_SeatBlocked(MobBusDetails);
  //     setShowPrice(true);
  //     setSubmitButon(true);
  //     setEnableInput(true);
                    ...
                    <Form onSubmit={handleSubmit}>
                      <div class="flex flex-col md:grid md:grid-cols-6 md:flex-row md:items-center md:gap-[1vw] gap-y-[4vw] md:mb-[1vw] mb-[3vw] md:px-[0vw] px-[2vw] pt-[1vw]">
                        <div className="col-span-1">
                          <p
                            className={`md:text-[1.1vw] text-[4vw] font-semibold  ${LuxuryFind(MobBusDetails?.Bus_Type_Name) === true
                                ? "text-[#393939]"
                                : "text-[#1F487C]"
                              }`}
                          >
                        ...
                        <div className="relative col-span-3">
                          ...
                          <ErrorMessage
                            name="email"
                            component="div"
                            className="text-red-500 text-[2.5vw] md:text-[0.8vw] absolute top-[10vw] md:top-[3vw] md:left-[0vw] left-[1vw] "
                          />
                        </div>
                                            ...
                                            {/* <div className="">
                                              <button
                                                ...
                                                className={`${!isSubmitting ||
                                                  ...
                                                  ? "cursor-pointer"
                                                  : "cursor-not-allowed"
                                                  } h-[10vw] w-[22vw] rounded-l-[1.5vw] text-[3.5vw] border-[0.1vw] text-white ${LuxuryFind(
                                                    MobBusDetails?.Bus_Type_Name
                                                  ) === true
                                                    ? "border-[#393939]"
                                                    : "border-[#1F487C]"
                                              ...
                                              <button
                                                ...
                                                className={`${!isSubmitting ||
                                                  ...
                                                  ? "cursor-pointer"
                                                  : "cursor-not-allowed"
                                                  } text-white h-[10vw] w-[22vw] rounded-r-[1.5vw] border-[0.1vw] text-[3.5vw] ${LuxuryFind(
                                                    MobBusDetails?.Bus_Type_Name
                                                  ) === true
                                                    ? "border-[#393939]"
                                                    : "border-[#1F487C]"
