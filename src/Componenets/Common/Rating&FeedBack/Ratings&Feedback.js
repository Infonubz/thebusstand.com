      ...
      >
        {({ isSubmitting, isValid, handleSubmit, errors, touched }) => (
          <Form onSubmit={handleSubmit}>
            {error ? (
              <div>
                <div className="overflow-hidden w-full md:h-[34.25vw] rounded-lg md:py-[1.5vw] py-[2.5vw] px-[2.5vw] over">
                    ...
                    <div>
                      <div className="relative">
                        <Field
                          ...
                          className="custom-placeholders md:px-[2vw] px-[4.5vw] py-[2vw] md:py-[0.75vw] md:h-[15vw] h-[50vw] w-full md:w-[30vw] md:text-[1vw] text-[3.5vw] text-[#1F487C] bg-[#D0E5FF4D] md:border-[0.1vw] border-[0.5vw] border-[#1F487C] md:rounded-[0.5vw] rounded-[1.2vw] outline-none"
                        />
                        <ErrorMessage
                          name="feedback"
                          component="div"
                          className="text-red-500 md:text-[0.8vw] text-[2.75vw] absolute md:bottom-[-1.5vw] bottom-[-3.5vw] left-[1.5vw]"
                        />
                      </div>
                    </div>
                  </div>
                </div>
                <div className=" flex justify-end px-[2vw] gap-x-[1vw] md:mt-0 mt-[4vw]">
                  <button
              ...
              <div>
                ...
                <div className="px-[1vw]">
                  ...
                  <div className="md:flex md:flex-col gap-y-[1vw] md:px-0 px-[2vw]">
                    <div className="md:grid md:grid-cols-5 md:gap-[1vw]">
                      <div className="relative md:col-span-3">
                        <input
                          ...
                          className={`border ${getValues.user_name ? "cursor-not-allowed" : ""
                            } placeholder:text-[3.5vw] md:placeholder:text-[1.2vw] md:text-[1vw] text-[3.2vw] border-gray-300 px-[0.5vw] rounded-[1.5vw] placeholder:text-[#1F487C] outline-none w-full bg-[#D0E5FF4D] text-[#1F487C] md:h-[3vw] h-[7vw] resize-none overflow-x-auto scrollbar-thin scrollbar-thumb-[#1F487C] scrollbar-track-[#D0E5FF4D]`}
                        />
                        {required.name && (
                        ...
                        <div className="relative">
                          <div className='md:block hidden'>
                            <Select
                              ...
                              className={` custom-rating-select  w-full md:h-[3vw] h-[7vw] text-[#1F487C] border-[0.1vw] rounded-2xl md:text-[1.2vw] ] md:mt-0  my-[4.5vw]`}
                              suffixIcon={
                                <span className="absolute top-[-1vw] left-[-2vw]">
                                  <RiArrowDropDownFill
                                    color="#AFAFAF"
                                    size={"3vw"}
                                  />
                          ...
                          <div className='md:hidden block'>
                            <Select
                              ...
                              value={getValues.occupation || occValue}
                              disabled={getValues?.occupation ? true : false}
                              className={`  custom-mobileRating-select w-full md:h-[3vw] h-[7vw] text-[#1F487C] border-[0.1vw] rounded-2xl md:text-[1.2vw] text-[1vw] md:mt-0  mt-[4.5vw]`}
                              suffixIcon={
                                <span className="absolute top-[-5vw] left-[-6.5vw]">
                                  <RiArrowDropDownFill
                                    color="#AFAFAF"
                                    size={"10vw"}
                                  />
                ...
                <div className=" flex md:justify-end justify-center px-[2vw] md:mt-0 mt-[3.5vw]">
                  <button
                    type="button"
                    onClick={handleClick}
                    className="bg-[#1F487C] md:mb-0 mb-[2.25vw] md:text-[1.2vw] text-[3vw] text-white font-bold rounded-full md:w-[13vw] w-[26vw] md:h-[2.5vw] h-[6vw]"
                  >
                    Next
                  </button>
                </div>
