              ...
              >
                ...
                {selectedDate ? (
                  ...
                  >
                    ...
                    >
                      {dateSelectionColor === true ? (
                        <div className="flex flex-col items-center md:mt-[-0.25vw] mt-[-0.5vw]">
                          <p className=" md:text-[0.8vw] text-[2.5vw] text-center">
                        ...
                        <div
                          ...
                          className="flex flex-col items-center justify-center mt-[1.2vw] md:mt-[.4vw]"
                        >
                          <p className="text-center font-semibold md:text-[1.2vw] md:block hidden">
                            <MdOutlineCalendarMonth
                              className="md:text-2xl text-3xl"
                              size={"2vw"}
                            />
                          </p>
                          <p className="text-center font-semibold md:text-[1.2vw] md:hidden block">
                            <MdOutlineCalendarMonth
                              className="md:text-2xl text-3xl"
                              size={"8vw"}
                            />
